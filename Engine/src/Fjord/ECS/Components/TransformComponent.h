...
namespace Fjord
{
	...
	public:
		...
		TransformComponent(const glm::vec3& pos, const glm::vec3& rot) : TransformComponent(pos, rot, glm::vec3(1.f)) {}
		TransformComponent(const glm::vec3& pos) : TransformComponent(pos, glm::vec3(0.f), glm::vec3(1.f)) {}
		TransformComponent() : TransformComponent(glm::vec3(0.f), glm::vec3(0.f), glm::vec3(1.f)) {}
		...
		void SetScale(const glm::vec3& rot);
		void SetRot(const glm::vec3& scale);
